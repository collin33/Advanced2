...
{
    public void Draw(Texture2D texture, SpriteBatch spriteBatch,float rotation, Vector2 position)
    {
        spriteBatch.Begin();
        ...
        spriteBatch.Draw(texture, position, null, Color.White, MathHelper.ToRadians(rotation), new Vector2(0, 0), new Vector2(1, 1), SpriteEffects.None, 0);
        spriteBatch.End();
